...
import 'package:biyer_juti/views/delete_account.dart';
import 'package:biyer_juti/views/edit_account.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(padding: ThemePadding.p4, children: [
          ...
          BasicNavigationButton(label: "Edit Full Profile", onTap: () => route(context, const EditAccount())),
          BasicNavigationButton(label: "Delete Profile", onTap: () => route(context, const DeleteAccount()), lastItem: true),
          Gap.gy6,
        ]));
  }
}
