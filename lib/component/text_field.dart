    ...
    return Padding(
        ...
        child: TextFormField(
            ...
            decoration: InputDecoration(
                ...
                contentPadding: ThemePadding.p4.copyWith(top: ThemePadding.value * 3) * 1.2,
  ...
  static Padding pill(
    ...
    return Padding(
        ...
        child: TextFormField(
            ...
            obscureText: (isPassword) ? !showPassword : false,
            controller: controller,
            style: boldStyle ? TextStyle(color: ThemeColor.secondary, fontSize: 14, fontWeight: FontWeight.bold, letterSpacing: 6) : TextStyle(color: ThemeColor.jetBlack, fontSize: 14, fontWeight: FontWeight.w500),
            autofocus: autoFocus,
            enabled: !isDisable,
            decoration: InputDecoration(
