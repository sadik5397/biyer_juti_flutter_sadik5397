...
class RequestButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(children: [
      ...
      if (state == RequestState.contactInfo)
        FloatingActionButton(
            shape: const CircleBorder(), onPressed: () {}, mini: true, elevation: 0, backgroundColor: ThemeColor.primary, child: const FaIcon(FeatherIcons.copy, size: 18, color: Colors.white)),
    ]);
  }
}
